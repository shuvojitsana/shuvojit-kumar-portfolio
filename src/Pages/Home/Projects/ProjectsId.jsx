            ...
            <div>
                ...
                <div className="flex gap-6 mx-20">
                    ...
                    <span>
                        ...
                        <Link href="https://toys-sports-master.web.app/" target="blank"><button className="btn mt-5 bg-purple-800 hover:bg-red-100  hover:text-black border-none text-white " >Demo</button>
                        </Link>
                    </span>
                </div>
